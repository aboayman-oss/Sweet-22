...
const content = {
  ...
  openingLetter: [
    "من يوم ما دخلتي حياتي وانتي بتضحكي ضحكتك الحلوة دي، الدنيا بقت شكل تاني.",
    "لسه فاكر أول مرة شفتك، في درس الجيولوجيا، وانا مش مصدق إزاي حبيت بنت من أول نظرة... حتى الكروكس بتاعك عجبني!",
    "من الواتساب للسناب شات، الكلام كان بيحلى كل يوم أكتر من اللي قبله،",
    "لحد ما بقينا مع بعض في 26 يونيو 2022، في نص امتحانات الثانوية العامة اللي كانت ضغط عالكل إلا إحنا الاتنين.",
    "دلوقتي بقالنا تقريبا 5 سنين، وانتي كل يوم بتثبتيلي إني اخترت صح.",
    "مش بس حبيبتي، إنتي أعز صحابي كمان، اللي أقدر أقعد معاها ساعات وماللش.",
    "كل سنة وانتي طيبة يا حبيبة."
  ],

  timelineTitle: "رحلتنا",
  timeline: [
    { date: "درس الجيولوجيا", image: "timeline-1.jpg",
      caption: "أول مرة شفتك... ولسه فاكر كل تفصيلة، حتى الكروكس!" },
    { date: "26 يونيو 2022", image: "timeline-2.jpg",
      caption: "في نص ضغط الثانوية العامة، قررنا نبقى مع بعض... أحسن قرار في حياتي." },
    { date: "دلوقتي", image: "timeline-3.jpg",
      caption: "بقالنا تقريبا 5 سنين، وكل يوم بحبك أكتر من اللي قبله." }
  ],

  giftHuntTitle: "رحلة الهدايا",
  giftHunt: [
    { video: "gift-1.mp4", caption: "دورت كتير عشان ألاقيلك حاجة تستاهلك... شوفي هلاقيت ايه!" },
    { video: "gift-2.mp4", caption: "مكملين الرحلة... في حاجة تانية مستنياكي!" },
    { video: "gift-3.mp4", caption: "وده آخر حاجة... يارب تعجبك زي ما انتي عاجباني." }
  ],

  reasonsTitle: "22 سبب بحبك عشانهم",
  reasons: [
    "عشان ضحكتك أول حاجة بتفرحني في يومي.",
    "عشان لما بقعد معاكي حاسس إني قاعد مع أعز صحابي.",
    "عشان من أول نظرة وانا حاسس إن في حاجة مختلفة فيكي (حتى الكروكس بتاعتك!).",
    "عشان دمك خفيف وعمرك ما بتخليني أزهق.",
    "عشان دماغك حلوة وبتفكري صح في كل حاجة.",
    "عشان اخترتي تبقي معايا في أصعب وقت - نص امتحانات الثانوية.",
    "عشان من الواتساب للسناب شات لحد دلوقتي، الكلام لسه بيحلى.",
    "عشان بتفهميني من غير ما أشرح كتير.",
    ...
    "عشان بتدعميني حتى وانتي مش قادرة تدعمي نفسك.",
    "عشان بتشتغلي بجد في التمرين، وده بيخليني فخور بيكي.",
    "عشان لسه بتحسسيني إني محظوظ إني اخترتك من أول يوم.",
    "عشان مع كل اللي بيحصل، لسه اخترتي تفضلي جنبي.",
    "عشان بقالنا تقريبا 5 سنين وكل يوم بيحسسني إنه أول يوم.",
    "عشان انتي مش بس حبيبتي دلوقتي، انتي المستقبل اللي باحلم بيه.",
    "عشان انتي حبيبة... وعمرك ما هتبقي حاجة عادية بالنسبالي."
  ],

  galleryTitle: "لحظات من عمرنا",
  gallery: [
    "gallery-1.jpg", "gallery-2.jpg", "gallery-3.jpg",
    "gallery-4.jpg", "gallery-5.jpg", "gallery-6.jpg"
  ],

  ourMomentsTitle: "لحظاتنا",
  ourMoments: [
    { video: "us-1.mp4", caption: "من أحلى اللحظات اللي عشناها مع بعض." },
    { video: "us-2.mp4", caption: "لسه فاكر كل ثانية فيها، وكل يوم بستنى نعمل ذكريات أكتر." }
  ],

  closingLetter: [
    "يا حبيبة،",
    "بقالنا تقريبا 5 سنين من يوم درس الجيولوجيا اللي غيّر حياتي، ومن يوم 26 يونيو 2022 اللي قررنا فيه نبقى مع بعض في أصعب وقت.",
    "النهارده انتي بتكبري سنة، وأنا مبسوط إني هكبر كل سنة جنبك.",
